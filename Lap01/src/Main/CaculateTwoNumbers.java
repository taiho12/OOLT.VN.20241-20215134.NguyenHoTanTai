...
public class CaculateTwoNumbers {
    public static void main(String[] args) {
        ...
        strNum1 = JOptionPane.showInputDialog(null,
            "Nguyen Ho Tan Tai - 20215134 - Please input the first number: ", "Input the first number", JOptionPane.INFORMATION_MESSAGE);
        num1 = Double.parseDouble(strNum1);

        strNum2 = JOptionPane.showInputDialog(null,
            "Nguyen Ho Tan Tai - 20215134 - Please input the second number: ", "Input the second number", JOptionPane.INFORMATION_MESSAGE);
